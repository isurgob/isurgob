...
<div class="site-login">
	...
	<div class="cfg" style="min-height: 173px;">
	...
	<div style="float:left;" style="min-height: 220px;">
		<div class="cfg" style="float:none;">
			...
			<div class="content">
				<?= Html::a('Localidad/Prov/Pa&iacute;s', ['config/localidad/index']); ?><br/>
	...
	<div class="cfg" style="min-height: 220px;">
		...
		<div class="content">
			...
			<?= Html::a('Cuadros y Cuerpos',$generico.'&t=37'); ?><br/>
	...
	<div class="cfg" style="min-height: 220px;">
		...
		<div class="content">
			<?= Html::a('Contador',$generico.'&t=57'); ?><br/>
	...
	<div class="cfg" style="float:none;">
		...
		<div class="content">
			...
			<?= Html::a('Forma de Pago',$generico.'&t=66'); ?><br/>
	...
	<div style="float:left;">
	<div class="cfg" style="float:none;min-height: 108px;">
	...
	<div class="cfg" style="min-height: 88px;">
		...
		<div class="content">
			...
			<?= Html::a('Grupo de Rubros',$generico.'&t=74'); ?><br/>
		</div>
	</div>
	</div>
	...
	<div class="cfg" style="float:none;">
		...
		<div class="content">
			...
			<?= Html::a('Medio de Pago',$generico.'&t=85'); ?><br/>
	...
	<div class="cfg" >
		...
		<div class="content">
			...
			<?= Html::a('Sucursales',$generico.'&t=80'); ?><br/>
		</div>
	</div>
	</div>

	<div class="cfg" style="min-height: 226px;">
		<div class="titulo">Apremio / Incump.</div>
		<div class="content">
			<?= Html::a('Estado Planilla',$generico.'&t=87'); ?><br/>
			<?= Html::a('Juzgado',$generico.'&t=88'); ?><br/>
			...
			<?= Html::a('Honorarios Judiciales',$generico.'&t=95'); ?><br/>
	...
	<div class="cfg" style='display:none'>
		...
		<div class="content">
			...
			<?= Html::a('Secretar&iacute;as',$generico.'&t=108'); ?><br/>
