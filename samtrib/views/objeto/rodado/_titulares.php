...
<table border="0" width="600px">
	<tr>		
		<td width="100px">
			...
			echo $this->render('//objeto/nuevoTitular', ['modelObjeto' => $extras['modelObjeto'], 'condRelacion' => $condRelacion]);
			Pjax::end();
		...
		<td align="right" width="500px">
			...
			echo Html::button('Nuevo', [
    								'class' => $clase,
    								'onclick'=>'$.pjax.reload({container:"#pjaxCargarModal", push : false, replace : false, type:"POST",data:{"action":1, "abrirModal" : true}});'
    								]);
    		?>
		</td>
	</tr>
...
<table border="0" width="600px" style="margin-top:5px;">
	<tr>
		<td align="left" width="600px">
			<?php
				...
				echo GridView::widget([
					'dataProvider' => $dp,
					'id' => (isset($idTabla) ? $idTabla : 'tablaTitularesRodado'),
