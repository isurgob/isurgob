...
//					$domiCambio->domicilio .= ' - ' . utb::getCampo("domi_provincia","prov_id=" . $domiCambio->prov_id,"nombre");
				 ...
				 if ($consulta == 3)
				 {
					...
					if ($mensj == '')
					{
						...
						echo '<script>$("#actualizaDatos").click();</script>';
...
<?php
			...
			echo "&nbsp;&nbsp;";
			echo Html::a('Cancelar', ['view', 'id' => $modelObjeto->obj_id], [
            			'class' => 'btn btn-primary',
        			]);

			echo Html::a('1234', ['view', 'id' => $modelObjeto->obj_id, 'm_text' => 'Datos grabados correctamente'], [
