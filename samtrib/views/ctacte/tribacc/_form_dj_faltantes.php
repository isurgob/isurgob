...
$this->params['breadcrumbs'][] = ['label' => 'DJ Faltantes'];
?>
<?php
$form = ActiveForm::begin(['fieldConfig' => ['template' => '{label}{input}'], 'validateOnSubmit' => false, 'id' => 'formDJFaltante']);
	...
	<div class="form" style="padding:10px;">
		<table border="0" width="100%" id="asd">
			...
			<tr>
				...
				<td colspan="6">
				<?php
				$acciones = [3 => 'Generar DJ Faltantes', 4 => 'Eliminar DJ Faltantes'];
				echo $form->field($model, 'accion')->dropDownList($acciones, ['prompt' => '', 'style' => 'width:100%;'])-> label(false); 
				?>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="6">
				<?php
				$condicion = "tobj <> 0 And tipo = 2 And dj_tribprinc <> 0";
					
				echo $form->field($model, 'trib_id')->dropDownList(utb::getAux('trib', 'trib_id', 'nombre', 0, $condicion), ['onchange' => 'cambiaTributo($(this).val());', 'id' => 'dlTributo', 'prompt' => '', 'style' => 'width:100%;'])->label(false); 
				?>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3">					
					...
					echo Html::button('<i class="glyphicon glyphicon-search"></i>', 
									...
									'data-toggle' => 'modal', 'data-target' => '#modalObjeto',
					...
					echo $this->render('//objeto/objetobuscarav', ['txCod' => 'codigoObjeto', 'txNom' => 'nombreObjeto', 'id' => 'busquedaObjeto', 'tobjeto' => $tipoObjeto, 'selectorModal' => '#modalObjeto']);
...
$botonAceptar = Html::button('Grabar',['class' => 'btn btn-success', 'onclick' => '$("#formDJFaltante").submit();']);
