...
<table>
	<tr>
		<td width="48px"><label>Tributo:</label></td>
		<td>
			<?= $form->field($model, 'trib_id', ['template' => $param['T_TAB_COL1_3']])->dropDownList($model->getTrib(),['prompt'=>'Seleccionar...',  'style' => 'width:350px;'])->label( false ); ?>
		</td>
	</tr>
</table>
		...
		<?php
			...
			Pjax::begin(['id' => 'cuentaCliente']);
				...
				if (isset($_POST['cta_id'])){
					...
					$valor = $model->getNombreCuenta($_POST['cta_id']);
