...
<ul id='ulMenuDer' class='menu_derecho'>
	...
	<li id='liImprimirBoleta' class='glyphicon glyphicon-print'>
		<?= Html::a('<b>Boleta</b>', ['imprimir','id' => $model->dj_id, 'tipo' => 2],['class' => 'bt-buscar-label', 'target' => '_black']); ?>
	</li>
	<li><hr style="color: #ddd; margin:1px" /></li>
	<?php } ?>
	...
	<?php
		/**
		 * Según el tipo de objeto, el sistema dirigirá a "Comercio" o "Persona".
		 */

		switch( utb::getTobj( $model->obj_id ) ){

			case 2:

				if (utb::getExisteProceso(3200)) {?>
			...
			case 3:
				...
				if (utb::getExisteProceso(3200)) {?>
				<li id='liComercio' class='glyphicon glyphicon-home'> <?= Html::a('<b>Persona</b>', ['objeto/persona/view','id' => $model->obj_id], ['class' => 'bt-buscar-label']) ?></li>
				<?php }
	...
	<?php } ?>
	<?php if (utb::getExisteProceso(3300)) {?>
	<li id='liListado' class='glyphicon glyphicon-list-alt'> <?= Html::a('<b>Listado</b>', ['//ctacte/listadoddjj/index'], ['class' => 'bt-buscar-label', 'data' => ['method' => 'post']])  ?></li>
	<?php } ?>
</ul>
