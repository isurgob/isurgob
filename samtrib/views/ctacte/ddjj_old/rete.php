...
/**
 * Forma que se dibuja para cargar retenciones a una DJ.
 * Recibo:
 * 			=> $model 						-> Modelo de Ddjj
 *			=> $action
 *			=> $dataProviderReteCargadas	-> Listado de retenciones cargadas.
 * 			=> $dataProviderRete 			-> Listado de retenciones que se pueden cargar.
...
<div id="ddjj_cargarRete_grillaRetenciones" style="padding-right:8px">
	...
	<h3><strong><?= "Retenciones" . ( $action == 4 ? ' cargadas' : '' ); ?></strong></h3>
	<?= GridView::widget([
