...
Pjax::begin(['id'=>'verificarExistencia']);
	...
	if ($tipo != 0 && $trib != 0 && $anio != 0 && $cuota != 0 && $obj_id != '')
	{
		/*
...
<table border="0">
	<tr>
		...
		<td>
			<label>Monto:</label>
			<?= Html::input('text','txMonto',$model->monto,['id'=>'pagocta_txMonto','class'=>'form-control','style'=>'width:80px;text-align:right','onchange'=>'cambioEdit();','readOnly'=>true]) ?></td>
		<td width="10px"></td>
		<td>
			<label>Límite:</label>
